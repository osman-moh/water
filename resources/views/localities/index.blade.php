...
@section('content')
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-lg-4">
                    <a href="{{route('localities.create')}}"  class="btn btn-primary" ><i class="fa fa-fw fa-plus-square"></i>
                               اضافة محلية
                    </a>
                </div>
            </div>
                ...
                <table id="Comm" class="table table-bordered" >
                    ...
                    @foreach($data as $kay=>$value)
                        <tr>
                            ...
                            <td>
                                <a  class="btn btn-success" href="{{route('localities.edit',$value->id)}}">
                                    تعديل

                                </a>
                            </td>
                            <td>
                   <form class="form-submit"   action="{{route('localities.destroy',$value->id)}}" method="POST">
