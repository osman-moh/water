@extends('layouts.app')
@section('title' , 'انواع الجهات المبلغة')
@section('content')
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-lg-4">
                    <a href="{{route('category.create')}}"  class="btn btn-primary" ><i class="fa fa-fw fa-plus-square"></i>
تصنيف جديد
                    </a>
                </div>
            </div>
            ...
            <div class="row" >
                ...
                <table id="Comm" class="table table-bordered" >
                    ...
                    @foreach($data as $key=>$value)
                        ...
                        <td>
                            <a  class="btn btn-success" href="{{route('category.edit',$value->id)}}">
                                تعديل

                            </a>
                        </td>
                        <td>
                              <form class="form-submit" action="{{route('category.destroy',$value->id)}}"method="POST">
