$(document).ready(function(){
	...
	fileinput_setting = {'showUpload':false, 'showPreview':false};
    ...
    $(document).on('submit', 'form#business_location_add_form', function(e){
		e.preventDefault();
		var data = $(this).serialize();
	...
	$(document).on('click', 'a.pay_purchase_due', function(e){
		e.preventDefault();
		$.ajax({
			url: $(this).attr("href"),
			dataType: "html",
	...
	$('table').on('click', 'a.print-invoice', function(){
        var href = $(this).data('href');
