<?php $__env->startSection('content'); ?>
    ...
    <div class="row" dir="rtl">
        ...
        <a href="<?php echo e(route('user.create')); ?>" class="btn btn-primary" href="#">
            <i class="fa fa-fw fa-plus"></i>اضافة مستخدم جديد  </a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel ">
                <div class="panel-heading text-right"> المستخدمين  </div>
                    ...
                    <table class="table table-bordered table-responsive text-center" dir="rtl">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('user.edit',$value->id)); ?>" class="btn btn-success" value="<?php echo e($value->id); ?>">
