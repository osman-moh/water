<?php $__env->startSection('title' , 'تعديل جهة بلاغ'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form id="send"  method="POST" action="<?php echo e(route('category.update',$data->id)); ?>">
                ...
                <div class="col-lg-12">
                    ...
                    <input placeholder="اسم الموقع" name="category" class="form-control" value="<?php echo e($data->name); ?>"
