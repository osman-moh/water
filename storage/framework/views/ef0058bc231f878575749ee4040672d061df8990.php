        ...
        <div class="box-body">
            ...
            <?php if(Session::has('step1')): ?>
                <form id="send"  method="POST" action="<?php echo e(route('City.update',Session::get('id'))); ?>" >
                    ...
                    <input type="hidden" name="name" value="<?php echo e(Session::get('name')); ?>" required autofocus>
                    <input type="hidden" name="Lloction_id" value="<?php echo e(Session::get('Lloction_id')); ?>" required autofocus>
                    <input type="hidden" name="regional_id" value="<?php echo e(Session::get('regional_id')); ?>" required autofocus>
                    <?php
            ...
            <?php else: ?>
                ...
                <form id="send"  method="POST" action="<?php echo e(route('City2')); ?>">
                    ...
                    <div class="col-lg-12">
                        <lebel>الاسم  : </lebel>
                        <input name="name" class="form-control" value="<?php echo e($data->name); ?>"   required="" pattern="[أ-يa-zA-Z0-9\s]{1,300}"     
