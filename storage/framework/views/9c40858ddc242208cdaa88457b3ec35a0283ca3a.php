        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <div class="container">
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-lg-2"><h5><strong>مكان استقبال البلاغ</strong></h5></div>
                        <div class="col-lg-3">
                            <h5>
                        ...
                        <div class="col-lg-2"><h5><strong>تاريخ استقبال البلاغ</strong></h5></div>
                        <div class="col-lg-3">
                            <h5>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-lg-2"><h5><strong>نوع الجهة المبلغة</strong></h5></div>
                        <div class="col-lg-1">
                            <h5>
                        ...
                        <div class="col-lg-1"><h5><strong>اسم المبلغ</strong></h5></div>
                        <div class="col-lg-2">
                            <h5>
                        ...
                        <div class="col-lg-1"><h5><strong>رقم الهاتف</strong></h5></div>
                        <div class="col-lg-2">
                            <h5>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-lg-2"><h5><strong>المنطقة الكبرى</strong></h5></div>
                        <div class="col-lg-1">
                            <h5>
                        ...
                        <div class="col-lg-1"><h5><strong>المحلية</strong></h5></div>
                        ...
                        <div class="col-lg-1"><h5><strong>المكتب</strong></h5></div>
                        <div class="col-lg-2"><h5>
                    ...
                    <hr>
                    <div class="row">
                            <div class="col-lg-1"><h5><strong>المدينة</strong></h5></div>
                            <div class="col-lg-2"><h5>
                            ...
                            <div class="col-lg-1"><h5><strong>المربع</strong></h5></div>
                            <div class="col-lg-2"><h5>
                            ...
                            <div class="col-lg-1"><h5><strong>رقم المنزل</strong></h5></div>
                            <div class="col-lg-2"><h5>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-lg-2"><h5><strong>وصف المنزل</strong></h5></div>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-lg-1"><h5><strong>نوع البلاغ </strong></h5></div>
                        <div class="col-lg-2"><h5>
                        ...
                        <div class="col-lg-1"><h5><strong>البند الفرعي </strong></h5></div>
                        <div class="col-lg-2"><h5>
                                
                            <?php echo e(empty($report->sub_type->name) ? '' : $report->sub_type->name); ?></h5></div>
                        <div class="col-lg-2"><h5><strong>تفصيل البلاغ </strong></h5></div>
                        <div class="col-lg-3"><h5></h5></div>
                    </div>
                    <hr>
                    <div class="row">
                            <div class="col-lg-1"><h5><strong>حالة البلاغ </strong></h5></div>
                            <div class="col-lg-2"><h5><?php echo e(empty($report->status->name)?'': $report->status->name); ?></h5></div>

                            <div class="col-lg-2"><h5><strong> تم استلام البلاغ بواسطة </strong></h5></div>
                            <div class="col-lg-2"><h5>
                                    <?php if(isset( $report->createdby )): ?>
                                    <?php echo e($report->ِcreatedby); ?>

                                   <?php endif; ?>
                               </h5></div>

                            <div class="col-lg-1"><h5><strong>تاريخ البلاغ </strong></h5></div>
                            <div class="col-lg-2"><h5>
                    ...
                    <div class="row">
                        <form action="/reports/update-status/<?php echo e($report->id); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-2"><label for="">تعديل حالة البلاغ</label></div>
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-2">
                                    <input type="radio" name="report_status" value="3" <?php echo e(($report->report_status == 4)? 'checked' :''); ?>>&nbsp;&nbsp;قيد التنفيذ
                                </div>
                                <div class="col-lg-3"> 
