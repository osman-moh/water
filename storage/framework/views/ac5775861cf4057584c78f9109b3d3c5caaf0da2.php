...
<?php $__env->startSection('title' , 'تعديل بيانات بند فرعي'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form id="send"  method="POST" action="<?php echo e(route('report_sub_types.update',$report_sub_type->id)); ?>">
                ...
                <div class="row">
                        <div class="col-lg-4">
                            <label>البند : </label>
                        <input placeholder=" اسم البند" name="name" class="form-control" required value="<?php echo e($report_sub_type->name); ?>"
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="report_type_id" required  
                                ...
                                <?php $__currentLoopData = $report_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value->id); ?>" <?php echo e(($report_sub_type->report_type_id == $value->id)?'selected' : ''); ?>> 
