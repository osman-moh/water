...
<?php $__env->startSection('title' , 'تعديل بيانات محلية'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form id="send"  method="POST" action="<?php echo e(route('localities.update',$data->id)); ?>">
                <?php echo e(csrf_field()); ?>

                <input name="_method" type="hidden" value="PUT">
                <div class="col-lg-12">
                    <label>المحلية : </label>
                    <input   name="locality" value="<?php echo e($data->name); ?>" class="form-control" 
					 required=""    
                ...
                <div class="col-lg-12">
					...
					>
                        ...
                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php echo e($data->city_id ==$value->id?"selected":""); ?>
