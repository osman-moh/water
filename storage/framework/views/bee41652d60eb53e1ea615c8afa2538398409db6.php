    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <?php if(Session::has('step1')): ?>
                <form id="send"  method="POST" action="<?php echo e(route('Square.store')); ?>">
            ...
            <form id="send"  method="POST" action="<?php echo e(route('Square2')); ?>">
                ...
                <div class="col-lg-12">
                  ...
                  <input placeholder=" اسم المربع" name="regional" class="form-control" 
      ...
      $("#regional").change(
          function () {
              ...
              $.get('/regionaloption/'+id,
                  function(data){
                      // alert(data)
                        html = "<select id='regional' class='form-control' name='regional_id'>";
                        html2 =html+data;
                        html3 = html2+ "<select>";
                      $('#or').html(html3);
                  });
