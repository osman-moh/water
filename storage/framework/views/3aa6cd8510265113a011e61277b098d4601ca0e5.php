...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
          <li  id="tour_step4">
            <a href="<?php echo e(route('home')); ?>" id="tour_step4_menu"><i class="fa fa-fw fa-cube"></i> <span>القائمة الرئيسة</span>
            </a>
          </li>
            <li  id="tour_step4">
            ...
            <li id="tour_step4">
                <a href="<?php echo e(route('report_sub_types.index')); ?>" id="tour_step4_menu"><i class="fa fa-fw fa-cube"></i> <span>
                    البنود الفرعية للبلاغات
                </span>
                </a>
            </li>
            <li id="tour_step4">
              <a href="<?php echo e(route('report_sub_details.index')); ?>" id="tour_step4_menu"><i class="fa fa-fw fa-cube"></i> <span>
