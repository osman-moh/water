<?php $__env->startSection('title' , 'الصفحة الرئيسة || هيئة مياه ولاية الخرطوم'); ?>
                ...
                <div class="btn-group pull-left" data-toggle="buttons">
                    <label class="btn btn-info active">
                        <input type="radio" name="date-filter"
                            data-start="<?php echo e($date_filters['this_day']['start']); ?>"
                            data-end="<?php echo e($date_filters['this_day']['end']); ?>"
                            checked> اليوم
                    </label>
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter"
						  data-start="<?php echo e($date_filters['this_week']['start']); ?>"
                            data-end="<?php echo e($date_filters['this_week']['end']); ?>"> الاسبوع
                    </label>
                   
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter"
						 data-start="<?php echo e($date_filters['this_month']['start']); ?>"
                            data-end="<?php echo e($date_filters['this_month']['end']); ?>"> الشهر
                    </label>
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter"
