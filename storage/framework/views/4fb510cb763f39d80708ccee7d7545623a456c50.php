<?php $__env->startSection('title' , 'تعديل بيانات منطقة'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form id="send"  method="POST" action="<?php echo e(route('cities.update',$data->id)); ?>">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input placeholder="اسم المنطقة" name="name" class="form-control" required value="<?php echo e($data->name); ?>"
