...
<?php $__env->startSection('title' , 'المحليات'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-lg-4">
                    <a href="<?php echo e(route('localities.create')); ?>"  class="btn btn-primary" ><i class="fa fa-fw fa-plus-square"></i>
                               اضافة محلية
                    </a>
                </div>
            </div>
                ...
                <table id="Comm" class="table table-bordered" >
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kay=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a  class="btn btn-success" href="<?php echo e(route('localities.edit',$value->id)); ?>">
                                    تعديل

                                </a>
                            </td>
                            <td>
                   <form class="form-submit"   action="<?php echo e(route('localities.destroy',$value->id)); ?>" method="POST">
